...
variable "params" {
  default = [
    ...
    { name = "roboshop.dev.mysql_endpoint", value = "rds-dev.cluster-cjvkzflxlvkt.us-east-1.rds.amazonaws.com", type = "String" },
    { name = "roboshop.dev.docdb.username", value = "roboshop123", type = "String" },
